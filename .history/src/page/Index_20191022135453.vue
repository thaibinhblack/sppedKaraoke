                        ...
                        <slide height="365px" v-for="(karaoke,index) in karaoke_province" :key="index">
                           <div class="item-karaoke-province">
                               <div class="image-karaoke-province">
                                   <router-link :to="'/karaoke?ID_PROVINCE='+kraoke.ID_PROVINCE"> <v-img height="300px" :src="$store.state.PUBLIC_URL + karaoke.IMAGE_PROVINCE"></v-img></router-link>
                               </div>
...
export default {
    ...
    methods: {
        ...
        {
            await this.$store.state.loading = true
            ...
            await this.$store.state.loading = false
        },
         next() {
