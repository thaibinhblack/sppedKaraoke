            ...
            <v-container grid-list-xs style="padding-bottom: 0px;">
                <v-row>
                    <v-col cols="12" sm="3" md="2" class="logo">
                        <h2 style="font-size:18px;"><router-link to="/" style="color:#333;">SPEED KARAOKE</router-link></h2>
                    </v-col>
                    ...
                    <v-col cols="12" sm="12" style="padding-bottom: 0px;"> 
                        ...
                        <ul class="list-option">
                            <li v-if="user.UUID_RULE != 'user-2019'"><router-link to="/manager-karaoke">Trang quản lý</router-link></li>
