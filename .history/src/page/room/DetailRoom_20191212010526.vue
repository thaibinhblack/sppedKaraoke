            ...
            <v-card v-if="booking_thanhtoan.STATUS == 2">
                <form action="" style="padding:15px;" @submit.prevent="api_thanh_toan_trcutiep()">
                    ...
                    <v-text-field
                        ...
                        :error="check_code_promotion.success"
                        :success="check_code_promotion.success"
                        :error-messages="check_code_promotion.message"
                        :success-messages="check_code_promotion.message"
