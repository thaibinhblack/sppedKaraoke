    ...
    <v-container grid-list-xs>
        <v-row>
            <v-col cols="12" sm="12" class="group-link" style="text-align:left;">
                 <star-rating :star-size="35" :show-rating="false" inactive-color="#e2e2e2 " active-color="#f65e39"></star-rating>
                 
            </v-col>
            <v-col cols="12" sm="8" md="7">
                <h2>{{karaoke.NAME_BAR_KARAOKE}} - {{room.NAME_ROOM_BAR_KARAOKE}}   </h2>
                <star-rating :inline="true" :star-size="20" :read-only="true" :show-rating="false" :rating="room.STAR_RATING"></star-rating> <small>({{room.NUMBER_RATED}}), {{room.VIEW_ROOM}} lượt xem</small>
