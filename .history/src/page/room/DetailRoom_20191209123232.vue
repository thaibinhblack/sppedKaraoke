            ...
            <v-col cols="12" sm="5" md="4" class="left-layout">
                <v-card class="booking">
                    <v-card-title primary-title>
                        <p style="text-align:left;width:100%;margin-bottom:0;font-weight:bold;font-size:18px;">{{room.RENT_COST.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}} <small style="margin-left:4px;font-size:13px;"> vnđ/h</small></p>
                    </v-card-title>
                    <v-card-text>
                        <v-row>
                           <v-col cols="12" sm="12">
