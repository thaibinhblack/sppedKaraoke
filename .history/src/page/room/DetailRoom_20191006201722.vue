...
<div id="detail-room">
    ...
    <v-container grid-list-xs>
        <v-row>
            ...
            <v-col cols="12" sm="5" md="4" style="position:relative">
                    ...
                    <v-card-text>
                        <v-row>
                           <v-col cols="12" sm="12">
                                ...
                                <button class="btn btn-booking">Đặt phòng ngay</button>
                                ...
                                <P align="center"><small>Tham gia ngày: {{karaoke.CREATED_AT}}</small></P>
                           </v-col>
                        </v-row>
                    </v-card-text>
                </v-card>
...
.booking {padding: 25px;position: fixed;width: 100%;}
</style>