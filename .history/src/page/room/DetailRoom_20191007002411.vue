                    ...
                    <v-card-text>
                        <v-row>
                           <v-col cols="12" sm="12">
                                ...
                                <button class="btn btn-booking" @click="bookingRoom()">Đặt phòng ngay</button>
                                <v-list-item two-line style="margin-top:15px">
                                    ...
                                    <v-list-item-title>
                                        <h2 class="name-bar-karaoke">{{karaoke.NAME_BAR_KARAOKE}}
    ...
    methods: {
        ...
        bookingRoom()
        {
            ...
            else
            {
                ...
                console.log(moment(time).format('DD-MM-YYYY, h:mm:ss'))
                data.append("TIME_START",moment(time).format('DD-MM-YYYY, h:mm:ss'))
                // data.append("TIME_START",)
                this.$http.post(this.$store.state.API_URL +'booking?api_token='+this.$session.get('token',data)).then((response) => {
