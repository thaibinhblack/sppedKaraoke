                        ...
                        <slide height="365px" v-for="(promotion,index) in promotions" :key="index">
                           <div class="item-karaoke-province">
                               <div class="image-karaoke-province">
                                   <router-link :to="'/promotion?UUID_PROMOTION='+promotion.UUID_PROMOTION"> <v-img height="300px" :src="$store.state.PUBLIC_URL + karaoke.BANNER_PROMOTION"></v-img></router-link>
                               </div>
