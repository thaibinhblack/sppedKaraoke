       ...
       <header-tool-bar />
        ...
        <v-container fluid grid-list-xs class="custom">
            <v-row>
                ...
                <hooper class="slider" height="365px" :settings="hooperSettings" :itemsToShow="3">
                        <slide height="365px" v-for="(promotion,index) in promotions" :key="index">
                           <div class="item-karaoke-province">
                               <div class="image-karaoke-province">
                                   <router-link :to="'/promotion?UUID_PROMOTION='+promotion.UUID_PROMOTION"> <v-img height="300px" :src="$store.state.PUBLIC_URL + promotion.BANNER_PROMOTION"></v-img></router-link>
                               </div>
                               <div class="content-karaoke-province">
                                   <p class="title">{{promotion.NAME_PROMOTION}}</p>
