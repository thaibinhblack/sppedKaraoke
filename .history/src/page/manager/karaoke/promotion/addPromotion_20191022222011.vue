                            ...
                            <v-col class="12" sm="4">
                                <v-menu
                                    ...
                                    <template v-slot:activator="{ on }">
                                        ...
                                        @blur="promotion.DATE_STARTED = parseDate(dateFormatted)"
                                        required
                                        v-on="on"
                                        ></v-text-field>
                                    </template>
                                    <v-date-picker v-model="promotion.DATE_STARTED" no-title @input="menu1 = false"></v-date-picker>
                                </v-menu>
                            </v-col>
                            <v-col class="12" sm="4">
                                <v-menu
                                    ...
                                    <template v-slot:activator="{ on }">
                                        ...
                                        persistent-hint
                                        prepend-icon="mdi-calendar-range"
                                        @blur="promotion.DATE_END = parseDate(dateFormatted)"
                                        required
                                        v-on="on"
                                        ></v-text-field>
                                    </template>
                                    <v-date-picker v-model="promotion.DATE_END" no-title @input="menu2 = false"></v-date-picker>
                                </v-menu>
                            </v-col>
                            <v-col cols="12" sm="12">
