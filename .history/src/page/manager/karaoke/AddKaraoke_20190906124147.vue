...
export default {
    ...
    methods:{
        ...
        CreateKaraoke()
        {
            ...
            data.append("UUID_BAR_KARAOKE",this.UUID_BAR_KARAOKE)
            data.append("ID_DISTRICT", this.karaoke.ID_DISTRICT)
            data.append("ID_PROVINCE", this.karaoke.ID_PROVINCE)
            data.append("LOGO_BAR_KARAOKE",this.LOGO_BAR_KARAOKE)
            ...
            data.append("EMAIL_BAR_KARAOKE",this.EMAIL_BAR_KARAOKE)
