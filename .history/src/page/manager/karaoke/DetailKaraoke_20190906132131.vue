        ...
        <v-row>
            ...
            <v-col cols="12" sm="12">
                <v-card>
                    ...
                    <v-card-text>
                        <v-row>
                            <v-col cols="12" sm="4" md="3" v-for="(image,i) in images" :key="i">
...
export default {
    ...
    methods:{
        ...
        ApiGetMedia()
        {
            axios.get(this.$store.state.API_URL +'image/'+this.$route.params.uuid+'?type=UUID_BAR_KARAOKE').then((response) => {
