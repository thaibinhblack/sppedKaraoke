                    ...
                    <v-card-text>
                        ...
                        >
                            <template v-slot:item.ACTION="{item}">
                                <router-link :to="'/manager-karaoke/karaoke/'+$route.params+uuid+'/room/'+item.UUID_ROOM_BAR_KARAOKE"></router-link>
                            </template>
                        </v-data-table>
                    </v-card-text>
                </v-card>
...
export default {
    ...
    methods:{
        ...
        ApiGetRoom()
        {
            axios.get(this.$store.state.API_URL +'room?UUID_BAR_KARAOKE='+this.$route.params.uuid).then((response) => {
