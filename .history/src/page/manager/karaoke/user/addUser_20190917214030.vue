    ...
    methods:{
        ...
        createUser()
        {
            ...
            else
            {
                ...
                this.$http.post(this.$store.state.API_URL + 'user',data).then((response) => {
        ...
        ApiGetRule()
        {
            this.$http.get(this.$store.state.API_URL + 'rule?user_create='+this.getUser.EMAIL).then((response) => {
        ...
        ApiGetKaraoke()
        {
            this.$http.get(this.$store.state.API_URL + 'karaoke?user_create='+this.getUser.EMAIL).then((response) => {
