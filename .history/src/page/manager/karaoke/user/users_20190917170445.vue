...
export default {
    ...
    methods: {
        ApiGetKaraoke()
        {
            ...
            {
                thiss.$http.get(this.$store.state.API_URL + 'karaoke?user_create='+this.$session.get('user').EMAIL).then((response) => {
                    this.karaokes = response.data
                })
            }
            else
            {
                thiss.$http.get(this.$store.state.API_URL + 'karaoke?user_create='+this.$session.get('user_social').email).then((response) => {
                    this.karaokes = response.data
                })
            }
