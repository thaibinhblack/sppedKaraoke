                            ...
                            <v-row>
                                <v-col cols="12" sm="12" class="group-logo-karaoke">
                                    <v-avatar
                                        ...
                                        color="#e2e2e2"
                                        class="logo-karaoke">
                                        <input type="file" class="input-logo"> 
                                        <img v-if="karaoke.logo != null" :src="src" alt="alt">
                                    </v-avatar>
                                </v-col>
                            </v-row>
...
.input-logo {position: absolute;width: 100%;left: 0;top: 0;opacity: 1;z-index: 999;width: 100%;height: 100%;}
</style>