...
export default {
    ...
    methods:{
        renderBanner()
        {
            ...
            this.karaoke.BANNER_KARAOKE = file
        ...
        async createKaraoke()
        {
            ...
            await this.$http.post(this.$store.state.API_URL + 'karaoke?api_token='+this.$session.get('token'),data,)
            .then((response) => {
...
.icon-upload {position: absolute;top: 50%;left: 50%;transform: translate(-50%,-50%);z-index: 998; cursor: pointer;}
</style>