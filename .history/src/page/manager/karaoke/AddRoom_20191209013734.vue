                    ...
                    <v-card>
                        <v-card-title primary-title>
                            ...
                            <v-card-text>
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="4" md="3">
                                        <v-checkbox label="Phòng mới" v-model="room.NEW_ROOM" value="1"></v-checkbox>
                                    </v-col>
                                     <v-col cols="12" sm="4" md="3">
                            ...
                            <v-card-actions>
                                <v-row>
                                    <v-col cols="12" sm="12">
                                        <button v-if="create == false" class="btn-add" type="submit"><v-icon>mdi-plus</v-icon> Lưu lại</button>
        ...
        async createRoom()
        {
            if(this.create == false)
            {
               ...
               else
               {
                    ...
                    data.append("DESIGN",this.room.DESIGN)
                    data.append("EVENT",this.room.EVENT)
                    data.append("NEW_ROOM",this.room.NEW_ROOM)
                    ...
                    .then(() => {
                        ...
                        this.create = true
                        this.room = {}
                        this.$router.push('/manager-karaoke/karaoke/'+this.$route.params.uuid)
                    }).catch(() => {
