...
export default {
    ...
    methods: {
        ...
        async updateRoom()
        {
            ...
            room.add("NAME_ROOM_BAR_KARAOKE",this.room.NAME_ROOM_BAR_KARAOKE)
            room.add("RENT_COST",this.room.RENT_COST)
            room.add("CONTENT",this.room.CONTENT)
            await this.$http.post(this.$store.state.API_URL + 'room/'+this.room.UUID_ROOM_BAR_KARAOKE,room).then(() => {
