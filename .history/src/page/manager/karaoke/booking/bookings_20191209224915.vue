                ...
                <div class="form-group row">        
                 ...
                 <div class="form-group row">
                    <div class="col-sm-9">
                        ...
                        <button type="button" class="btn btn-add" style="margin-left:15px;" @click="bill = false">Đóng</button>
                    </div>
                </div>
            </form>
       </v-card>
               ...
               <form @submit.prevent="booking_now()">
                    <v-row>
                        ...
                        <v-col cols="12" sm="12" md="6">
                            ...
                            ></v-text-field>
                             <button type="button" class="btn-add" style="float:right;margin-top:10px;margin-left:15px;" @click="dialog_form_book = false">Đóng</button>
