                ...
                <v-card-text>
                    ...
                    >
                        ...
                        <template v-slot:item.ACTIONS="{item}">
                            <button v-if="item.STATUS == 0" title="Duyệt"><v-icon>mdi-checkbox-marked-outline</v-icon></button>
                            <button v-if="item.STATUS == 0" title="Hủy"><v-icon>mdi-close-box-multiple-outline</v-icon></button>
