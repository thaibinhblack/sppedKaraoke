                ...
                <v-card-text>
                    ...
                    >
                        ...
                        <template v-slot:item.ACTIONS="{item}">
                            ...
                            <span v-if="item.STATUS == 1" ><button @click="api_nhan_phong(item.UUID_BOOKING)" title="Duyệt"><v-icon>mdi-checkbox-marked</v-icon></button></span>
                            <span style="margin-left: 10px"  v-if="item.STATUS == 0 || item.SATUS == 1"><button @click="api_huy_book(item.UUID_BOOKING)" title="Hủy"><v-icon>mdi-close-box-multiple-outline</v-icon></button></span>
