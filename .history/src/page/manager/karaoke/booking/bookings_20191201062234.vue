       ...
       <v-card>
            <form action="" style="padding:15px;">
                ...
                <div class="form-group row">        
                    <label for="inputPassword3" class="col-sm-4 col-form-label" ><strong>Tài khoản khách hàng</strong></label>
                    <div class="col-sm-8">
                        {{booking_thanhtoan.EMAIL}}
                    </div>
                </div>
                 <div class="form-group row">        
                    <label for="inputPassword3" class="col-sm-4 col-form-label" ><strong>Tên khách hàng</strong></label>
                    <div class="col-sm-8">
                        {{booking_thanhtoan.DISPLAY_NAME}}
                    </div>
                </div>
                <div class="form-group row">        
                    <label for="inputPassword3" class="col-sm-4 col-form-label" ><strong>Đặt phòng vào lúc</strong></label>
                    <div class="col-sm-8">
