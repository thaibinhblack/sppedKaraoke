...
<div id="page-booking" style="padding:15px;">
    ...
    >
       <v-card>
            <form action="" style="padding:15px;" @submit.prevent="api_thanh_toan()">
                ...
                <div class="form-group row">        
                 ...
                 <div class="form-group row">
                    <div class="col-sm-9">
                        ...
                        <button type="submit" class="btn btn-primary btn-form" >Thanh toán</button>
                    </div>
                </div>
            </form>
       </v-card>
    ...
    methods: {
        ...
        api_thanh_toan()
        {
            ...
            form_booking.append("UUID_USER",this.booking_thanhtoan.UUID_USER)
             this.axios.post(this.$store.state.API_URL + 'thanhtoan/'+id+'/nhan?api_token='+this.$cookies.get('token'),form_booking).then((response) => {
                alert(response.data.message)
                this.ApiGetBooking()
            })
