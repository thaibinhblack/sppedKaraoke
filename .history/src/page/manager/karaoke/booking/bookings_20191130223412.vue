                ...
                <v-card-text>
                    ...
                    >
                        ...
                        <template v-slot:item.ACTIONS="{item}">
                            <span v-if="item.STATUS == 0" ><button title="Duyệt"><v-icon>mdi-checkbox-marked-outline</v-icon></button></span>
                            <span style="margin-left: 10px"  v-if="item.STATUS == 0"><button title="Hủy"><v-icon>mdi-close-box-multiple-outline</v-icon></button></span>
