       ...
       <v-card>
            <form action="" style="padding:15px;">
                ...
                <div class="form-group row">        
                 ...
                 <div class="form-group row">        
                    <label for="inputPassword3" class="col-sm-5 col-form-label" ><strong>Chi nhánh</strong></label>
                    <div class="col-sm-7">
                        {{booking_thanhtoan.NAME_BAR_KARAOKE}}
                    </div>
                </div>
                 <div class="form-group row">        
                    <label for="inputPassword3" class="col-sm-5 col-form-label" ><strong>Phòng</strong></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row">        
                    ...
                    <div class="col-sm-7">
                       {{(total * (booking_thanhtoan.RENT_COST / 60) ).toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') vnđ }}
                    </div>
                </div>
            </form>
       </v-card>
