                ...
                <v-row>
                    ...
                    <v-col cols="12" sm="12" md="6">
                        <v-text-field
                            ...
                            id="id"
                        ></v-text-field>
                        <label>Thời gian đặt phòng {{booking_new.TIME_START}}</label>
                        <vue-timepicker v-model="booking_new.TIME_START"></vue-timepicker>
...
export default {
    ...
    data()
    {
        return {
            ...
            booking_new: {
                    TIME_START: {
                        HH: new Date().getHours().length == 1 ? '0'+new Date().getHours() : new Date().getHours(),
    ...
    methods: {
        ...
        api_karaokes()
        {
            this.axios.get(this.$store.state.API_URL + 'karaoke').then((response) => {
