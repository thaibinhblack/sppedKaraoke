    ...
    computed: {
        ...
        total(){
            if(this.bill == true)
            {
                ...
                const minues = this.booking_thanhtoan.TIME_START.slice(2,4)
                return (day*24*60) + (hours * 60) + minues - (new Date().getHours() *24*60) + (new Date().getHours() * 60) + (new Date().getMinutes())
