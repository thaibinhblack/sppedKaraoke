        ...
        <v-row>
            ...
            <v-col cols="12" sm="7" md="8">
                ...
                <section>
                    ...
                    <v-row style="margin:0 -5px">
                        <v-col cols="12" sm="3" md="2" v-for="(room,i) in rooms" :key="i" style="padding:5px;">
                            <v-img :src="$store.state.PUBLIC_URL + room.IMAGE_ROOM" height="150px"></v-img>
                            <p>{{room.NAME_ROOM_BAR_KARAOKE}}</p>
                        </v-col>
                    </v-row>
                </section>
            </v-col>
