                ...
                <section style="margin-top:25px;">
                    ...
                    <v-row style="margin:0 -5px">
                        <v-col cols="12" sm="4" md="3"  v-for="(room,i) in rooms" :key="i" style="padding:5px;">
                           <div class="item-room">
                                <router-link :to="'/karaoke/'+karaoke.URL_SAFE+'/'+room.UUID_ROOM_BAR_KARAOKE"><v-img :src="$store.state.PUBLIC_URL + room.IMAGE_ROOM_BAR_KARAOKE" height="180px"></v-img></router-link>
