...
export default {
    ...
    methods:{
        ...
        chatNow()
        {
            const client = stream.connect('ra8xkyr6hyw8', 'afu693gh9dehnqdmcjxz49rq43s8hdy2uymad2qum2rprdu4bhdx7ks2vvzbxhes', '60636');
            const userToken = client.createUserToken('the-user-id');
            client = stream.connect('andc5xdsrgvd', userToken,  '60636');
