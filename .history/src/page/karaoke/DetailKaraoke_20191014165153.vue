        ...
        <v-row>
            ...
            <v-col cols="12" sm="7" md="8">
                <h2 class="name-karaoke">{{karaoke.NAME_BAR_KARAOKE}} 
                    ...
                    <v-icon class="star-rating" v-for="(star,i) in stars" :key="i" :class="{'active': star.class}" @click="rating(i)">mdi-star</v-icon>
                </h2>
                <P>
    ...
    methods:{
        ...
        rating(i)
        {
            this.stars =  this.stars.filter((value,index,array) => {
                if(i >= index)
                {
                    return array[index].class = 'active'
                }
                else
                {
                    return array[index].class = ''
                }
            })
        }
    },
