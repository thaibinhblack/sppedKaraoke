            ...
            <v-col cols="12" sm="8" md="9">
                ...
                <section class="comment">
                    ...
                    <a-comment v-for="(comment,index) in comments" :key="index">
                        ...
                        <!-- <a-tooltip slot="datetime" :title="moment(comment.CREATED_AT).format('YYYY-MM-DD HH:mm:ss')">
...
section.comment {background: #fff;padding: 10px;border: 1px solid #e2e2e2;border-radius: 5px;}
</style>