        ...
        <v-row>
            ...
            <v-col cols="12" sm="7" md="8">
                <h2 class="name-karaoke">{{karaoke.NAME_BAR_KARAOKE}} 
                    ...
                    <v-icon size="30px" class="star-rating" data-id="1">mdi-star</v-icon>
                    <v-icon size="30px" class="star-rating" data-id="2">mdi-star</v-icon>
                    <v-icon size="30px" class="star-rating" data-id="3">mdi-star</v-icon>
                    <v-icon size="30px" class="star-rating" data-id="4">mdi-star</v-icon>
                    <v-icon size="30px" class="star-rating" data-id="5">mdi-star</v-icon>                     </h2>
                <P>
                ...
                <p><v-icon>mdi-map-marker</v-icon> {{karaoke.ADDRESS_BAR_KARAOKE}} <a :href="'/map?UUID_BAR_KARAOKE='+karaoke.UUID_BAR_KARAOKE" target="_blank">  Xem bản đồ </a> </p>
...
console.log(stars)
  stars.forEach(star => {
    if (star.dataset.id < current) {
      ...
      ratingNum.innerText = `${star.dataset.id}/5`;
    } else {
