        ...
        <v-row>
            ...
            <v-col cols="12" sm="12">
                ...
                <v-row class="group-time">
                    <v-col cols="12" sm="6">
                        <div class="time_start left">
                            <p>Thời gian áp dụng</p>
                            <span>{{TIME_START}}</span>
                        </div>
                    </v-col>
                    <v-col cols="12" sm="6">
                        <div class="time_start right">
                            <p>Thời gian áp dụng</p>
                            <span>{{TIME_END}}</span>
                        </div>
                    </v-col>
...
.group-time .time_start {display: inline-block;width: 200px;text-align: center;float: right;border: 1px solid #e2e2e2;background: #fff;}
</style>