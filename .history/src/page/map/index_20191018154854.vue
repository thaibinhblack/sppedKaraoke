                ...
                <v-row>
                   <v-list-item two-line>
                       ...
                       <v-list-item-content>
                           ...
                           <P class="text-map"><v-icon>mdi-map-marker</v-icon> {{karaoke.NAME_PROVINCE}}, {{karaoke.NAME_DISTRICT}}, {{karaoke.ADDRESS_BAR_KARAOKE}}</P>
                            <p><router-link :to="'/karaoke/'+karaoke.URL_SAFE">Xem chi tiết</router-link></p>
                       </v-list-item-content>
                   </v-list-item>
                </v-row>
            </div>
