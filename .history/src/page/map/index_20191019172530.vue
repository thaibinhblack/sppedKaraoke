...
<div id="map">
    ...
    <v-row class="main-map">
        <v-col cols="12" sm="4" md="3">
            <div class="item-karaoke" v-for="(karaoke,index) in karaokes" :key="index" :class="{acitve: getActive(karaoke.OBJECTID)}">
                <v-icon class="icon-active">mdi-checkbox-marked</v-icon>
                <v-row>
...
.item-karaoke.active .icon-active {opacity: 1;}
.icon-active {position: absolute;right: 0;top: 0px;z-index: 999;background: #fff;color: #f65e39;opacity: 0;}
</style>
