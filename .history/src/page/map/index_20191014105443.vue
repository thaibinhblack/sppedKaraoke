...
<div id="map">
    ...
    <button class="btn btn-add-karaoke"><v-icon size="16px">mdi-pencil</v-icon></button>
...
.btn-add-karaoke {position: absolute;top: 186px;z-index: 999; left: 55px;width: 31px;height: 31px;border: 1px solid #e2e2e2;background: #fff;}
</style>
