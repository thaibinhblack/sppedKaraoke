                    ...
                    <v-list-item-avatar>
                     ...
                     <v-list-item-content>
                        ...
                        <v-list-item-subtitle>
                            <small>{{user.EMAIL != null ? user.EMAIL : ''}}</small>
                        </v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
                <v-divider></v-divider>
                <v-list-item>
                    <select name="" id="" class="option-store">
                        <option value="null">Chọn chi nhánh</option>
                        <option v-for="(store,index) in stores" :key="index" :value="store.UUID_BAR_kARAOKE">
                            {{store.NAME_BAR_KARAOKE}}
                        </option>
                    </select>
                </v-list-item>
