                ...
                <v-row>
                    ...
                    <v-col cols="12" md="3">
                        <div class="group-search">
                            ...
                            <input v-model="map.NAME_BAR_KARAOKE" class="input-search" type="text" placeholder="Nhập từ khóa tìm kiếm" />
                        </div>
                    </v-col>
                    <v-col cols="12" md="3" style="padding: 0 12px;">
                        <v-row>
                            <v-col cols="12" md="6">
                                <div class="group-search">
                                    <select class="input-search" name="provinces" v-model="map.ID_DISTRICT" @change="changeDistrict()">
                                        <option selected value="null">Chọn hình thức tìm kiếm</option>
                                        <option value="0">Tìm kiếm trong hệ thống</option>
                                        <option value="1">Tìm kiếm trên bản đồ</option>
                                        
                                    </select>
                                </div>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-btn class="btn-search" color="primary" @click="search_karaoke()">TÌM KIẾM</v-btn>
                            </v-col>
                        </v-row>
...
export default {
    ...
    methods: {
        ...
        search_karaoke()
        {
            this.$router.push('/search?ID_PROVINCE='+this.map.province+'&ID_DISTRICT='+this.map.ID_DISTRICT)
        }
    },
    created()
    {
