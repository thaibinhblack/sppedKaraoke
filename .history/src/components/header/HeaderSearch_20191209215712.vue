...
export default {
    ...
    methods: {
        ...
        search_karaoke()
        {
            this.axios.get(this.$store.state.API_URL + 'search?ID_PROVINCE='+this.map.province+'&ID_DISTRICT='+this.map.ID_DISTRICT+'&NAME_BAR_KARAOKE='+this.map.NAME_BAR_KARAOKE)
            .then((response) => {
