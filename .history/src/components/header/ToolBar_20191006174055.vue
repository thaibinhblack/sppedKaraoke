<template>
     <v-toolbar>
                <v-row  no-gutters dense style="padding: 15px;width:100%">
                    <v-col cols="12" md="3">
                        <h3><span><v-icon class="btn-menu" v-if=" user != null" :class="{active: menuManager}" @click="closeOpenSidebar()" >mdi-menu</v-icon></span> <router-link to="/">SPEED KARAOKE</router-link></h3>
                    </v-col>
                    ...
                    <v-col cols="12" md="9">
                        ...
                        <ul v-else>
                            <li><span>Hotline: 0947164024</span></li>
                            <!-- <li><router-link to="/manager-karaoke/dashboard"><span><v-icon>mdi-email</v-icon> {{user.EMAIL}} </span></router-link></li> -->
