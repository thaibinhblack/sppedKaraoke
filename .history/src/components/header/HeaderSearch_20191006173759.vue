                ...
                <v-row>
                    <v-col cols="12" md="3">
                        <div class="group-search">
                            ...
                            <select class="input-search" name="provinces" v-model="map.province">
                    ...
                    <v-col cols="12" md="3">
                        <div class="group-search">
                            <v-icon>mdi-map-marker</v-icon>
                            <select class="input-search" name="provinces">
...
export default {
    ...
    methods: {
        ...
        ApiDistrict(UUID_PROVINCE)
        {
            this.$http.get(this.$store.state.API_URL + 'district?UUID_PROVINCE='+UUID_PROVINCE).then((response) => {
