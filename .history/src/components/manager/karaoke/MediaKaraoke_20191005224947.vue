                    ...
                    <v-card-text>
                        <v-row v-if="room == true">
                            <v-col cols="12" sm="3" md="2" style="position:relative">
                                ...
                                <v-img width="100%" ref="imageRoom" height="150px" style="background:#e2e2e2;" @change="uploadImageRoom()"></v-img>
...
export default {
    ...
    methods: {
        ...
        uploadImageRoom()
        {
            ...
            this.$http.post(this.$store.state.API_URL + 'room/'+this.$route.uuid_room+'?api_token='+this.$session.get('token'),data)
            .then((response) => {
