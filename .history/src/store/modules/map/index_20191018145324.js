...
import { addFeatures,getFeature  } from '@esri/arcgis-rest-feature-layer';
...
const mutations = {
    getFeature: (state,payload) => {
        getFeature({
            ...
            console.log(feature,state.view)
            state.view.popup.open({
                ...
                "<tr><th>Long </th><td>" + (feature.attributes.ADDRESS != null ? parseFloat(feature.attributes.ADDRESS) : '(Rỗng)') + "</td></tr> " +
                "<tr><th>Lat </th><td>" + (feature.attributes.ADDRESS != null ? parseFloat(feature.attributes.ADDRESS) : '(Rỗng)') + "</td></tr> " +
                "</table> ",
            })
        })
    },
